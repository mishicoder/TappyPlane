...
import dBackground from "../utils/draw_background.js";

const programmerCredits = ( data ) => {
...
function credits()
{
    ...
    scene('credits', (cursor) => { //? Inicio de la escena
        ...
        //? Credits
        //todo *****************************************************************************************************************************
        const programmer = programmerCredits( data );
        const animation = animationCredits( data );
        const graphics = graphicsCredits( data );
        const sound = soundCredits( data );
        ...
        backButton.pos.y = 500;
        const btnMaxY = height() - 100;

        onUpdate(() => {

            if ( backButton.pos.y > btnMaxY ) backButton.pos.y -= 8;
            if ( backButton.pos.y < btnMaxY ) backButton.pos.y = btnMaxY;
